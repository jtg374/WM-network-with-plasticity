...
datapath = ['/gpfsnyu/scratch/jtg374/WM_Plasticity_parallel/UniformPerturbHomeostaticOnly/' 'UniformP' num2str(a*100) 'HT' num2str(r_target) 'HLR' num2str(lrH) datestr(now,'_yymmdd_HH_MM') ];
mkdir(datapath)
disp(datapath)
